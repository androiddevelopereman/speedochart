...
const routes = [
  ...
  { path: '/donutchart', name: 'DonutChart', component: DonutChart ,meta: { title: 'DonutChart' }  },
  { path: '/piechart', name: 'PieChart', component: PieChart ,meta: { title: 'PieChart' }  },
  { path: '/speedometerchart', name: 'SpeedometerChart', component: SpeedometerChart,meta: { title: 'SpeedometerChart' }  },
